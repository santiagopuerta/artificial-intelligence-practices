...
Agent::ActionType Agent::DondeGirar(){
    ...
    switch(orientacion){
        case 0:
                delante = mapa[(x+8)%9][y];
                izquierda = mapa[x][(y+8)%9];
                derecha = mapa[x][(y+1)%9];
                break;
        case 1:
                delante = mapa[x][(y+1)%9];
                izquierda = mapa[(x+8)%9][y];
                derecha = mapa[(x+1)%9][y];
                break;
        case 2:
                delante = mapa[(x+1)%9][y];
                izquierda = mapa[x][(y+1)%9];
                derecha = mapa[x][(y+8)%9];
                break;
        case 3:
                delante = mapa[x][(y+8)%9];
                izquierda = mapa[(x+1)%9][y];
                derecha = mapa[(x+8)%9][y];
                break;
    }
